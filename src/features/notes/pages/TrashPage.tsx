...
import { useItems, useRepo } from '@/features/notes/repository/NoteRepositoryContext';
import { notifications } from '@mantine/notifications';
import { ItemIcon } from '@/shared/components/ItemIcon';
import { openAdaptiveDialog } from '@/shared/components/AdaptiveDialog';
      ...
      children: (close) => (
        <Stack gap="md">
          <Group gap={6} wrap="nowrap">
            <ItemIcon icon={AlertTriangle} size="md" color="var(--mantine-color-red-5)" />
            <Stack gap={4}>
              <Text size="sm">
              ...
              <Group justify="space-between">
                ...
                <Group gap={4}>
                  <Button
                    size="xs"
                    variant="default"
                    leftSection={<ItemIcon icon={RotateCcw} size="sm" />}
                    onClick={() => {
                      repo.restore(i.id);
                  ...
                  <Button
                    ...
                    color="red"
                    variant="light"
                    leftSection={<ItemIcon icon={Trash2} size="sm" />}
