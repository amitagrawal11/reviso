...
import { openItemDialog } from '@/features/notes/dialogs/NotesDialogs';
import { useItems, useModePath, useRepo } from '@/features/notes/repository/NoteRepositoryContext';
  ...
  return (
    <Container size="md" py="xl">
      ...
      <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="md">
        <Card withBorder>
          <Group>
            <ItemIcon icon={FilePlus} size="xl" />
        ...
        <Card withBorder>
          <Group>
            <ItemIcon icon={FolderPlus} size="xl" />
        ...
        <Card withBorder>
          <Group>
            <ItemIcon icon={Keyboard} size="xl" />
        ...
        <Card withBorder>
          <Group>
            <ItemIcon icon={BookOpen} size="xl" />
