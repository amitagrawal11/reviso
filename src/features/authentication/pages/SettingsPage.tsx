...
import { updateUserPassword } from '@/features/authentication/api/UserProfileApi';
import { supabase } from '@/features/authentication/api/SupabaseClient';
import { usingSupabase, useItems } from '@/features/notes/repository/NoteRepositoryContext';
import {
  usePreferences,
  setPreference,
  type Density,
              ...
              {localCount > 0 ? (
                <>
                  <Alert
                    variant="light"
                    color="yellow"
                    icon={<ItemIcon icon={AlertTriangle} size="md" />}
                  ...
                  <Group justify="flex-end">
                    <Button
                      ...
                      loading={importing}
                      leftSection={<ItemIcon icon={CloudUpload} size={16} />}
                    >
                      Sync to my account
                    </Button>
                  </Group>
