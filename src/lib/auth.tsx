...
import { hydrateFromUpstream, setUpstreamSync, type Preferences } from './preferences';
 ...
 * and render Shell immediately instead of showing Landing first.
 *
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  // "authenticated, not loading" so RealRoot renders Shell immediately on
  // refresh instead of flashing Landing → Shell. The real session object
